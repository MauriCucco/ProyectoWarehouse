...
const createCountry = async (idRegion, nombrePais) => {
    ...
    try {
        ...
        const data = await region.paises.push({nombrePais});
...
const createCity = async (idRegion, idPais, nombreCiudad) => {
    ...
    try { 
        ...
        const data = await pais.ciudades.push({nombreCiudad});
...
const modifyCountry = async (idRegion, idPais, nombrePais) => {
    ...
    try {
        ...
        const { _id: id } = await pais.set("nombrePais", nombrePais, { runValidators: true });
...
const modifyCity = async (idRegion, idPais, idCiudad, nombreCiudad) => {
    ...
    try { 
        ...
        const { _id: id } = await ciudad.set("nombreCiudad", nombreCiudad, { runValidators: true });
